  ...
  return (
    ...
    >
      <div className="flex flex-col items-center max-w-4xl mx-auto">
        {/* Título */}
        <h1 className="text-amber-700 text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-8 sm:mb-10">
          Sobre o Gestor360°
        </h1>

        {/* Texto de introdução */}
        <p className="text-base sm:text-lg md:text-xl text-white leading-relaxed text-center sm:text-left">
        ...
        {/* Lista de benefícios */}
        <ul className="text-base sm:text-lg md:text-xl text-white leading-relaxed space-y-4 mt-8 list-none">
        ...
        {/* Texto final */}
        <p className="text-base sm:text-lg md:text-xl text-white leading-relaxed text-center sm:text-left mt-8 sm:mt-10">
